...
public class RestaurantAddActivity extends AppCompatActivity {
    ...
    private void validateData() {
        ...
        //get data
         restaurant = binding.restaurantEt.getText().toString().trim();
         description = binding.descriptionEt.getText().toString().trim();
         operating_hours = binding.operatingHoursEt.getText().toString().trim();
        ...
        if (TextUtils.isEmpty(operating_hours)){
            Toast.makeText(this, "Please enter operating hours ...!", Toast.LENGTH_SHORT).show();
        }
        else {
            addCategoryFirebase();
        }
    ...
    private void addCategoryFirebase() {
        ...
        hashMap.put("operating_hours", ""+operating_hours);
